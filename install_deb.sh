...
apt-get update && apt-get upgrade -y && apt-get install -y apache2 wget git  r-base libmysqlclient-dev r-cran-ggplot2 r-cran-plyr r-cran-reshape2 libcairo2-dev curl npm php php-pear php-mysql php-curl libapache2-mod-php php-mcrypt php-json php-xml php-dom
